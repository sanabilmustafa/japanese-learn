...
export default function Home() {
  const card_data = [
    {
      ...
      heading: 'Learning English to Japanese Flipcards',
      description: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.'
    },
    {
      img: 'https://cdn.tailgrids.com/2.0/image/application/images/blogs/blog-01/image-02.jpg',
      heading: 'Learning English to Japanese Flipcards',
      description: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.'
    },
    {
  ...
  return (
    <div>
  <Navbar/>
    <div className="bg-blue-100 min-h-screen section ">
      <section className="container mx-auto p-8">
        <div className="text-center">
          <h1 className=" mt-24 text-4xl font-bold mb-4 text-blue-400">Welcome to Your Japanese Language Journey!</h1>
          <p className="mx-32 mt-7 text-lg text-gray-700 mb-8">
          Learning Japanese is your gateway to exploring a world of captivating traditions, innovative technology, and breathtaking landscapes. Whether you're driven by a passion for travel, an interest in Japanese art and literature, or the desire to excel in a global career, mastering this language opens doors to new experiences and connections. Embrace the challenge, and embark on a rewarding journey of cultural enrichment and personal growth as you dive into the Japanese language.
          </p>
          {/* <Link href="/components/card"> */}
            <a href="/components/card" className="bg-blue-500 hover:bg-blue-600 text-white font-semibold px-6 py-3 rounded-full shadow-lg hover:shadow-xl transition duration-300 transform hover:scale-105 inline-block">
              Start Learning
            </a>
          {/* </Link> */}
        </div>
        {/* Add more content and sections below */}
      </section>

      <section class="pb-10 lg:pt-[50px] lg:pb-20">
      <h2 className="mt-0 mb-7 text-4xl font-bold text-blue-400 text-center">What You Can Learn Here</h2>
      ...
      <header className="text-blue-400 py-6 text-center">
        <h2 className="text-4xl font-semibold">Why Should You Learn Japanese?</h2>
      </header>
      ...
      <main className="container mx-auto py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="rounded-lg shadow-lg bg-white p-6">
            <img src="https://www.japan-academy.in/blog/wp-content/uploads/2022/07/Things-Indians-Should-Know-About-Japanese-Culture-870x600.jpg" alt="Japanese Culture" width={300} height={200}/>
            <h2 className="text-xl font-semibold mt-4">Cultural Enrichment</h2>
            <p className="text-gray-600 mt-2">Japanese culture is a tapestry of ancient traditions and modern innovations. Learning Japanese provides you with a passport to explore this rich cultural heritage. From the serene beauty of tea ceremonies and traditional festivals to the bustling streets of Tokyo, understanding the language enhances your cultural immersion. Dive into centuries-old customs, arts, and cuisine, and gain insights into a culture that values harmony, discipline, and precision.</p>
          </div>

          {/* Point 2 */}
          <div className="rounded-lg shadow-lg bg-white p-6">
            <img src="" alt="Japanese Business" width={300} height={200} />
            <h2 className="text-xl font-semibold mt-4">Business and Career Opportunities</h2>
            <p className="text-gray-600 mt-2">Japan boasts one of the world's largest economies and is home to global giants like Toyota, Sony, and Nintendo. Proficiency in Japanese opens doors to a plethora of career opportunities. Whether you aspire to work in international business, technology, or academia, fluency in Japanese can give you a competitive edge. Building relationships and negotiating in Japanese business culture can be a game-changer for your career growth.</p>
          </div>

          {/* Point 3 */}
          <div className="rounded-lg shadow-lg bg-white p-6">
            <img src="" alt="Travel in Japan" width={300} height={200} />
            <h2 className="text-xl font-semibold mt-4">Travel and Adventure</h2>
            <p className="text-gray-600 mt-2">Japan's diverse landscapes, from cherry blossom-covered parks to snow-capped mountains, offer endless travel adventures. Learning Japanese allows you to navigate the country with ease, connect with locals, and savor the authentic flavors of Japanese cuisine. Beyond tourist hotspots, venture off the beaten path and discover hidden gems. You'll find that knowing the language enriches your travel experiences and deepens your appreciation of Japan's beauty.</p>
          </div>
        </div>
      </main>
      </section>

      <section className="mb-10 ml-20 flex justify-evenly items-center">
          {navigation_card.map((c) => (
            <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-lg">
                <a href="#">
                    <h5 class="mb-2 text-3xl font-bold tracking-tight text-gray-900">{c.head}</h5>
                </a>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">{c.para}</p>
                <button href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-600">
                    {c.button}
        ...
        >
          <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              ...
              <h3 className="text-2xl font-semibold">Our Website</h3>
            ...
            <div
              class="grid grid-cols-3 md:grid-cols-4 gap-8 lg:col-span-2 lg:grid-cols-4"
            >
              <div>
